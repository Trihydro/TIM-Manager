...
keytool -import -alias resdf -storepass changeit -noprompt -trustcacerts -keystore /usr/lib/jvm/java-8-openjdk-amd64/jre/lib/security/cacerts -file ${WYOCV_RES_DIR}/resdf.wyoroad.info.cer