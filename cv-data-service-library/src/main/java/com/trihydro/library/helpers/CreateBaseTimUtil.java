...
public class CreateBaseTimUtil {
    ...
    public WydotTravelerInputData buildTim(WydotTim wydotTim, TimGenerationProps genProps, ContentEnum content,
        ...
        dataFrame.setNotUsed((short) 0); // as of J2735 this should be set to 0 and is ignored
        dataFrame.setNotUsed1((short) 0); // as of J2735 this should be set to 0 and is ignored
        dataFrame.setNotUsed2((short) 0); // as of J2735 this should be set to 0 and is ignored
        dataFrame.setNotUsed3((short) 0); // as of J2735 this should be set to 0 and is ignored
