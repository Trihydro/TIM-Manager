...
public class BsmPart2SuveService extends CvDataServiceLibrary {
	...
	public static Long insertBSMPart2SUVE(J2735BsmPart2Content part2Content, J2735SupplementalVehicleExtensions suve, Long bsmCoreDataId) {
		...
		try {
            ...
            bsmSuvePreparedStatement = connection.prepareStatement(bsmSuveInsertQueryStatement, new String[] {"bsm_part2_suve_id"});
			...
			if(suve.getClassDetails() != null && suve.getClassDetails().getResponseEquip() != null &&  suve.getClassDetails().getResponseEquip().getValue() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getClassDetails().getResponseEquip().getValue().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
			...
			if(suve.getClassDetails() != null && suve.getClassDetails().getVehicleType() != null && suve.getClassDetails().getVehicleType().getValue() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getClassDetails().getVehicleType().getValue().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
			...
			if(suve.getWeatherProbe() != null && suve.getWeatherProbe().getRainRates() != null && suve.getWeatherProbe().getRainRates().getRateFront() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getWeatherProbe().getRainRates().getRateFront().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
			...
			if(suve.getWeatherProbe() != null && suve.getWeatherProbe().getRainRates() != null && suve.getWeatherProbe().getRainRates().getRateRear() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getWeatherProbe().getRainRates().getRateRear().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
			...
			if(suve.getWeatherProbe() != null && suve.getWeatherProbe().getRainRates() != null && suve.getWeatherProbe().getRainRates().getStatusFront() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getWeatherProbe().getRainRates().getStatusFront().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
			...
			if(suve.getWeatherProbe() != null && suve.getWeatherProbe().getRainRates() != null && suve.getWeatherProbe().getRainRates().getStatusRear() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getWeatherProbe().getRainRates().getStatusRear().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
			...
			if(suve.getObstacle() != null && suve.getObstacle().getLocationDetails() != null && suve.getObstacle().getLocationDetails().getValue() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getObstacle().getLocationDetails().getValue().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
			...
			if(suve.getStatus() != null && suve.getStatus().getLocationDetails() != null && suve.getStatus().getLocationDetails().getValue() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getStatus().getLocationDetails().getValue().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
			...
			if(suve.getTheRTCM() != null && suve.getTheRTCM().getRtcmHeader() != null && suve.getTheRTCM().getRtcmHeader().getOffsetSet() != null && suve.getTheRTCM().getRtcmHeader().getOffsetSet().getAntOffsetX() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getTheRTCM().getRtcmHeader().getOffsetSet().getAntOffsetX().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
			...
			if(suve.getTheRTCM() != null && suve.getTheRTCM().getRtcmHeader() != null && suve.getTheRTCM().getRtcmHeader().getOffsetSet() != null && suve.getTheRTCM().getRtcmHeader().getOffsetSet().getAntOffsetY() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getTheRTCM().getRtcmHeader().getOffsetSet().getAntOffsetY().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
			...
			if(suve.getTheRTCM() != null && suve.getTheRTCM().getRtcmHeader() != null && suve.getTheRTCM().getRtcmHeader().getOffsetSet() != null && suve.getTheRTCM().getRtcmHeader().getOffsetSet().getAntOffsetZ() != null)
				bsmSuvePreparedStatement.setString(fieldNum, suve.getTheRTCM().getRtcmHeader().getOffsetSet().getAntOffsetZ().toString());
			else
				bsmSuvePreparedStatement.setString(fieldNum, null);
			fieldNum++;
